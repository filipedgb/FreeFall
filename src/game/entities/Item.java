...
/**
 * Esta classe serve de classe pai para todos os itens do jogo, ou seja, todos
 * os power ups que o jogador pode "apanhar"
 * 
...
public abstract class Item extends GameObject {
	...
	/**
	 * Recebe um jogador e é suposto definir aquilo que lhe acontece quando o
	 ...
	 * 
	 * @param numSeconds
	 *            - numero de segundos que se pretende que o item esteja
	 *            desactivado apos ser apanhado
	 */
